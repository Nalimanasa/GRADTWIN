...
function Scrappending() {
  ...
  const fetchItems = () => {
    axios.get('https://gradtwin-backend.onrender.com/scrap_pending/')
   ...
   const approveItem = async (itemId) => {
    try {
      await axios.post(`https://gradtwin-backend.onrender.com/scrap_pending_Id/${itemId}/`);
  ...
  return (
    <div className="pending">
        <center><br/><br/>
              <h2 style={{textAlign:"center"}}> SCRAP PENDING LIST</h2>
